...
const ColorThemeStep: React.FC = () => {
  const { selectedColorTheme, setSelectedColorTheme, setCurrentStep, selectedDesignStyle } =
    useBoltBuilderStore();
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-300">
          Select a color palette that reflects your brand and creates the right mood.
        </p>
      </div>
      ...
      <div className="flex justify-between pt-8">
        <Button onClick={() => setCurrentStep('design-style')} variant="outline">
