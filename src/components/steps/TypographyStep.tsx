...
const TypographyStep: React.FC = () => {
  const { selectedTypography, setSelectedTypography, setCurrentStep } = useBoltBuilderStore();
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-300">
          Select fonts and styles that enhance readability and reflect your brand.
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {fonts.map((font) => (
            <FontCard
              ...
              onClick={() =>
                setSelectedTypography({ ...selectedTypography, fontFamily: font.family })
              }
            />
          ))}
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedTypography({ ...selectedTypography, headingWeight: e.target.value })
            }
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedTypography({ ...selectedTypography, bodyWeight: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg bg-white/5 border-white/20 text-white border
                     focus:ring-2 focus:ring-blue-500/50 focus:border-transparent
                     transition-all duration-200
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedTypography({ ...selectedTypography, headingSize: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg bg-white/5 border-white/20 text-white border
                     focus:ring-2 focus:ring-blue-500/50 focus:border-transparent
                     transition-all duration-200
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedTypography({ ...selectedTypography, textAlignment: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg bg-white/5 border-white/20 text-white border
                     focus:ring-2 focus:ring-blue-500/50 focus:border-transparent
                     transition-all duration-200
      ...
      <div className="glass-card rounded-lg p-6">
        ...
        >
              ...
              fontWeight:
                selectedTypography.headingWeight === 'Bold'
                  ...
                  : selectedTypography.headingWeight === 'Light'
                    ...
                    : '400',
              fontSize:
                selectedTypography.headingSize === 'Large'
                  ? '2.5rem'
                  : selectedTypography.headingSize === 'Medium'
                    ? '2rem'
                    : '1.5rem',
            }}
          ...
          <p
            style={{
              fontWeight:
                selectedTypography.bodyWeight === 'Bold'
                  ? '700'
                  : selectedTypography.bodyWeight === 'Light'
                    ? '300'
                    : '400',
            }}
            className="text-gray-300 leading-relaxed"
          >
            This is how your typography will look across your website. The quick brown fox jumps
            over the lazy dog. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
      ...
      <div className="flex justify-between pt-8">
        <Button onClick={() => setCurrentStep('color-theme')} variant="outline">
          Back to Color Theme
        </Button>
